class Character < ApplicationRecord
  ...
  has_many :settings, -> { ordered }, through: :character_tags, source: :setting
  has_many :gallery_groups, -> { ordered }, through: :character_tags, source: :gallery_group, dependent: :destroy
